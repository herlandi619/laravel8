    ...
    <div class="card mb-3 text-center">
        ...
        <div class="card-body">
          ...
          <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none btn btn-primary">Read Me..</a>
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    <a href="/posts?category={{ $post->category->slug }}">
                        <div class="position-absolute px-2 py-2 text-white" style="background-color: rgba(0, 0, 0, 0.5)">{{ $post->category->name }}</div>
                    </a>
                    ...
                    <div class="card-body">
                      ...
                      <a href="/posts/{{ $post->slug }}" class="text-decoration-none btn btn-primary">Read Me..</a>
                    </div>
                  </div>
            </div>
